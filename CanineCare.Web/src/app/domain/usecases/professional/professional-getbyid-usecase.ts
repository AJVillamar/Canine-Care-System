...
export class ProfessionalGetByIdUsecase implements UseCase<string, ActionResult<ProfessionalModel>> {

    constructor(private _repository: ProfessionalRepository) { }

    execute(params: string): Observable<ActionResult<ProfessionalModel>> {
